...
import{a as Me}from"./73NWWLM3.js";import{d as Ke,e as Ue,f as Fe}from"./ULV3D265.js";import{c as Be,d as He,e as Ge}from"./FVKTV62N.js";import{a as h}from"./WZXA5XPB.js";import{a as kn,b as Ce,c as Se,d as Ae}from"./KBGRTZ3S.js";import{c as Ee,d as Te,e as qe}from"./U6E22USS.js";import{a as $}from"./MONT6PMR.js";import{a as Pe,b as xn,c as On,d as Ie,e as $e,f as je}from"./BFGFT7E3.js";import{a as Ne}from"./46OWJR6X.js";import{a as De}from"./TSB6PODJ.js";import{a as Le}from"./NIH6ZKB3.js";import"./SQVG3CEM.js";import"./REFX2EKS.js";import"./NSIQWNYL.js";import"./UKSQ7B5H.js";import"./2WUJ57QA.js";import"./XWZNQKXF.js";import"./NAGDQV7J.js";import{g as Re}from"./4PT55VGO.js";import"./PFYPTG4G.js";import{C as we,H as ve,V as w,X as ke,aa as xe,c as O,ca as _,ja as Oe,q as R,s as be}from"./OZMIIHFH.js";import"./NEWT5A6S.js";import"./NB54XRRU.js";import"./HJYFWIVE.js";import"./RFWIIJFG.js";function M(e){return{requires:["typescript"],errorModes:["throw"],load:()=>import("./3XSOTIDJ.js").then(n=>({run:n.tanstackQueryGenerator(e)}))}}var z={outputMode:"it always emits one self-contained file",runtime:"the runtime is always embedded in the generated file",argsStyle:"inputs follow the target language's own idiom",importExt:"the generated file has no relative imports"},I={typescript:{load:()=>import("./V4SBON7Y.js").then(e=>({run:e.typescriptGenerator,sample:e.typescriptSample,docs:e.typescriptDocs}))},zod:{load:()=>import("./NGC5R7OH.js").then(e=>({run:e.zodGenerator}))},transformers:{requires:["typescript"],dateTypes:["Date"],load:()=>import("./NWMTC4AN.js").then(e=>({run:e.transformersGenerator}))},"tanstack-query":M("react"),"tanstack-query-vue":M("vue"),"tanstack-query-svelte":M("svelte"),"tanstack-query-solid":M("solid"),swr:{requires:["typescript"],errorModes:["throw"],load:()=>import("./XOZ4UMDG.js").then(e=>({run:e.swrGenerator}))},mock:{requires:["typescript"],load:()=>import("./SQYP47H6.js").then(e=>({run:e.mockGenerator}))},cli:{requires:["typescript","zod"],errorModes:["throw"],load:()=>import("./62X4OKFV.js").then(e=>({run:e.cliGenerator,sample:e.cliSample,docs:e.cliDocs}))},python:{notApplicable:z,load:()=>import("./X3MZMREJ.js").then(e=>({run:e.pythonGenerator,sample:e.pythonSample,docs:e.pythonDocs,options:e.pythonOptions}))},go:{errorModes:["throw"],notApplicable:z,load:()=>import("./L4GUU6OS.js").then(e=>({run:e.goGenerator,sample:e.goSample,docs:e.goDocs}))},php:{errorModes:["throw"],notApplicable:z,load:()=>import("./45LW7ZJ2.js").then(e=>({run:e.phpGenerator,sample:e.phpSample,docs:e.phpDocs}))}};function K(e,n,t,r){let s=new Set(e);n.goPackage!==void 0&&!s.has("go")&&w.warn(`generate-client: goPackage is ignored \u2014 it declares the Go package clause, and no selected generator uses it (add --generator go).
