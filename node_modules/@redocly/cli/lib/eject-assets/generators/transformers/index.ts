// Ejected from @redocly/client-generator@0.4.4 — the built-in "transformers" generator.
...
// `redocly eject-generator transformers --update`.
...
export default {
  name: 'transformers',
  run: transformersGenerator,
  requires: ["typescript"],
  dateTypes: ["Date"],
  requiresGenerator: '^0.4.4',
};
